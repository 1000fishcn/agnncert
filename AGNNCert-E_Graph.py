...
from utils import evaluate, resolve_checkpoint_path
...
path = resolve_checkpoint_path("./checkpoints", "robust_e", paper, dataset, T)
...
out_test,M,inference_details = r_model.predict(test_mask, return_details=True, **inference_args)
